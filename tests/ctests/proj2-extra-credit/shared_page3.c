/* Allocate all memory to top of userspace (USERTOP), then deallocate 1 page using sbrk(-PGSIZE), then call shmem_access(3), then fork and have parent and child read and write. */
#include "types.h"
#include "stat.h"
#include "user.h"
