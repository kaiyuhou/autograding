/* Allocate all memory to top of userspace (USERTOP) except for 1 page at the top, then call shmem_access(1), then fork and have parent and child read and write. */
#include "types.h"
#include "stat.h"
#include "user.h"
