/* Allocate all memory to top of userspace (USERTOP), then deallocate 2 pages, then call shmem_access on 2 pages, then fork and have parent and child read and write. */
#include "types.h"
#include "stat.h"
#include "user.h"
